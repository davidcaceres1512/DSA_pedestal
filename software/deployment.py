...
cmd_shell=[
    'gnome-terminal -x bash -c \"/usr/bin/python /home/soporte/Downloads/DSA_pedestal-master/software/nucleo_logger_server.py; exec bash\"',
    'gnome-terminal -x bash -c \"/usr/bin/python /home/soporte/Downloads/DSA_pedestal-master/software/nucleo_logger_pedestal.py; exec bash\"',
    'gnome-terminal -x bash -c \"/usr/bin/python /home/soporte/Downloads/DSA_pedestal-master/software/streamdecodetest.py; exec bash\"'
] 
...
T_cmdShell1.start()
T_cmdShell2.start()
time.sleep(20) #timeout for the uc_pedestal to reboot and initialize
